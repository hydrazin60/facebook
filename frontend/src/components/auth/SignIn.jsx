...
//             </div>
//           </div>
//           <div className=" lg:w-1/3 sm:w-1/2 w-full h-[72%] bg-white z-10 absolute shadow-lg rounded-lg ">
...
//             </div>
//             <div className="m-4">
//               <div className="flex justify-between py-3 gap-3 mt-3">
//                 <Input
//                   type="text"
//                   placeholder="First Name"
//                   className="h-10 text-lg bg-gray-100 border-2 border-gray-300"
...
//                     <Button className=" w-60 bg-green-600 text-xl font-bold">Sign Up</Button>
//                   </div>
//                 </div>
//               </div>
//             </div>
