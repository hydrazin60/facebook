              ...
              <div className="w-full h-auto flex flex-col gap-3">
                <div className="w-full flex gap-2">
                  {user?.profilePic ? (
                    ...
                    <span className="h-11 w-11 flex items-center justify-center rounded-full border border-zinc-500 text-lg font-semibold bg-zinc-300">
                      {user?.firstName?.[0]}.{user?.lastName?.[0]}
                    </span>
                  )}
                  <div>
